...
**Route:** `lb-public-gw.smoke.test` → service `lb-public-gw` → endpoint `43.159.34.11:80`
...
**Route:** `lb-public-nogw.smoke.test` → service `lb-public-nogw` → endpoint `43.159.34.11:80`
**GatewayLink:** none
...
| 3 | Public + GatewayLink | 43.159.34.11:80 | none | ✅ Safe |
| 4 | Public, no GatewayLink | 43.159.34.11:80 | PUBLIC_TARGET_EGRESS, GATEWAY_LINK_BYPASS_RISK | ⚠ Warning |
