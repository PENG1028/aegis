...
|------|---------|----------|-----------|------|
| Server A | `node_VM-0-4-ubuntu` | VM-0-4-ubuntu | 43.160.211.232 | from_node / relay resolver |
| Server B | `node_VM-0-11-ubuntu` | VM-0-11-ubuntu | 43.159.34.11 | target_node / relay dispatch |
...
```json
{
  ...
  "gateway_url": "http://43.159.34.11:443",
  "gateway_port": 443,
  "gateway_host": "43.159.34.11",
  "route_id": "rt_relay",
  ...
  "risks": [],
  "recommendation": "send request to public gateway 43.159.34.11:443 with GatewayLink auth"
}
```
