...
## Case 3: Public Target with GatewayLink — <SERVER_B_IP>:80 ✅ Safe
...
## Case 4: Public Target without GatewayLink — <SERVER_B_IP>:80 ⚠ Warning
...
| public + GatewayLink | public | No | <SERVER_B_IP>:80 |
| public, no GatewayLink | public | No | <SERVER_B_IP>:80 |
