...
**Scenario:** Route `app.example.com` targets `43.159.34.11:80` downstream server B, with GatewayLink attached.
  ...
  "risks": [
    {
      ...
      "severity": "warning",
      "message": "route exposed.example.com targets public IP 43.159.34.11"
    },
    {
      "code": "GATEWAY_LINK_BYPASS_RISK",
      "severity": "warning",
      "message": "route exposed.example.com targets public IP 43.159.34.11 without Gateway Link"
    }
  ],
  ...
  "risks": [
    {
      "code": "SELF_LOOP",
      "severity": "error",
      "message": "route target 43.160.211.232 is the gateway itself — would cause loop"
    }
  ]
}
```
