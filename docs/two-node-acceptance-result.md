...
| 2 | Aegis bind-http-domain → 43.159.34.11:80 | ✅ | status=success |
| 3 | Safe apply | ✅ | "apply completed" |
| 4 | Trace → remote gateway | ✅ | reachable=True, 43.159.34.11:80 |
...
[6] target     matched  43.159.34.11:80 reachable ✓
