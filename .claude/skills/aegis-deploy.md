...
# SSH access
ssh ubuntu@43.160.211.232 "echo ok"
ssh ubuntu@43.159.34.11 "echo ok"
```
...
| Server | IP | Role |
|--------|-----|------|
| Server A | 43.160.211.232 | Primary: panel + gateway + Caddy + HAProxy |
| Server B | 43.159.34.11 | Secondary: remote node + backend services |
...
1. Open http://43.160.211.232 in browser
...
ssh ubuntu@43.160.211.232 "curl -s -o /dev/null -w '%{http_code}' --connect-timeout 3 http://43.159.34.11:80/"
```
