...
#   Node B        : 43.159.34.11, RelayHandler, local service on 127.0.0.1:<PORT_B>
#   Node C        : 43.160.211.232, RelayHandler, local service on 127.0.0.1:<PORT_C>
#
...
#   7. SSH key-based access from dev machine to ubuntu@43.159.34.11 and ubuntu@43.160.211.232
#
# Notes:
...
# Node B (Server B — 43.159.34.11)
NODE_B_SSH="ubuntu@43.159.34.11"
NODE_B_PUBLIC_IP="43.159.34.11"
PORT_B=2724                      # Local test service port on Node B

# Node C (Server A — 43.160.211.232)
NODE_C_SSH="ubuntu@43.160.211.232"
NODE_C_PUBLIC_IP="43.160.211.232"
