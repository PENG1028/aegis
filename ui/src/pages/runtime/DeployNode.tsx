    ...
    <div className="p-6 space-y-6">
      ...
      <Card title="SSH 部署">
        <div className="space-y-3 max-w-md">
          <div><label className="text-xs text-a-muted block mb-1">SSH 地址</label><Input value={ssh} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setSsh(e.target.value)} placeholder="ubuntu@<SERVER_A_IP>" /></div>
