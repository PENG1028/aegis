...
func TestServiceListDoesNotExposeRawToken(t *testing.T) {
	...
	svc.Register("server-b", "43.159.34.11", "", 443, TypeUpstream, true)
...
func TestCheckAuthEncryptedRelayPath(t *testing.T) {
	...
	gw, rawSecret, err := svc.Register("server-b", "43.159.34.11", "", 443, TypeUpstream, true)
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
...
func TestLegacyHMACBackwardCompat(t *testing.T) {
	...
	gw, rawSecret, err := svc.Register("server-b-legacy", "43.159.34.11", "", 443, TypeUpstream, true)
	if err != nil {
...
func TestBackfillEncrypted(t *testing.T) {
	...
	gw, _, err := svcLegacy.Register("server-b-legacy", "43.159.34.11", "", 443, TypeUpstream, true)
	if err != nil {
		t.Fatalf("Register (legacy) failed: %v", err)
	}
...
func TestBackfillAlreadyEncrypted(t *testing.T) {
	...
	gw, _, err := svc.Register("server-b", "43.159.34.11", "", 443, TypeUpstream, true)
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
...
func TestEncryptedSecretNotInLogs(t *testing.T) {
	...
	gw, secret, err := svc.Register("server-b", "43.159.34.11", "", 443, TypeUpstream, true)
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
...
func TestLegacyHMACIsDegraded(t *testing.T) {
	...
	repo := NewRepository(db)
	svc := NewService(repo, "gw_self", "server-a", nil)
	gw, _, err := svc.Register("server-b-legacy", "43.159.34.11", "", 443, TypeUpstream, true)
	if err != nil {
		t.Fatalf("Register (legacy) failed: %v", err)
	}
	...
	gw2, _, err := svc2.Register("server-b-enc", "43.159.34.12", "", 443, TypeUpstream, true)
	if err != nil {
