...
func TestArtifactProviderUsesDefaultGitHubArtifactForLinuxAMD64(t *testing.T) {
	p := localAegisArtifactProvider{
		...
		download: func(ctx context.Context, url string) (string, func() error, error) {
			want := "https://raw.githubusercontent.com/PENG1028/aegis/fde575ffb4e8503739acb512fef4731f0b0202a2/aegis-linux-amd64"
			if url != want {
	...
	if artifact.Source != "https://raw.githubusercontent.com/PENG1028/aegis/fde575ffb4e8503739acb512fef4731f0b0202a2/aegis-linux-amd64" {
