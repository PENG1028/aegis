...
func TestArtifactProviderUsesDefaultGitHubArtifactForLinuxAMD64(t *testing.T) {
	p := localAegisArtifactProvider{
		...
		download: func(ctx context.Context, url string) (string, func() error, error) {
			want := "https://raw.githubusercontent.com/PENG1028/aegis/8dc738d91c93d7a577476e26eca5ebc1383461b1/aegis-linux-amd64"
			if url != want {
	...
	if artifact.Source != "https://raw.githubusercontent.com/PENG1028/aegis/8dc738d91c93d7a577476e26eca5ebc1383461b1/aegis-linux-amd64" {
