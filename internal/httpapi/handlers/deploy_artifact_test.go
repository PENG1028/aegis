...
func TestArtifactProviderUsesDefaultGitHubArtifactForLinuxAMD64(t *testing.T) {
	p := localAegisArtifactProvider{
		...
		download: func(ctx context.Context, url string) (string, func() error, error) {
			want := "https://raw.githubusercontent.com/PENG1028/aegis/f1a19d3a38ff4c8e27e2aa8a34e6968f663bebe8/aegis-linux-amd64"
			if url != want {
	...
	if artifact.Source != "https://raw.githubusercontent.com/PENG1028/aegis/f1a19d3a38ff4c8e27e2aa8a34e6968f663bebe8/aegis-linux-amd64" {
